...
def showQueue(args, api: API):
    ...
    req = api.make_request(
        method="GET",
        url=api.WATCHLIST_LIST_ENDPOINT.format(args.account_data.account_id),
        params={
            "n": 1024,
...
def viewSeries(args, api: API):
    ...
    req = api.make_request(
        method="GET",
        url=api.SEASONS_ENDPOINT.format(args.account_data.cms.bucket),
        params={
            "locale": args.subtitle,
...
def viewEpisodes(args, api: API):
    ...
    req = api.make_request(
        method="GET",
        url=api.EPISODES_ENDPOINT.format(args.account_data.cms.bucket),
        params={
            "locale": args.subtitle,
...
def startplayback(args, api: API):
    ...
    req = api.make_request(
        method="GET",
        url=api.STREAMS_ENDPOINT.format(args.account_data.cms.bucket, args.episode_id),
        params={
            "locale": args.subtitle
        }
    )
